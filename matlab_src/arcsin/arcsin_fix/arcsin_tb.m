...
for cnt = 1:len
    [arcsin(cnt)] = arcsin_fixed(target(cnt));
end
...
saveas(gcf, 'report/arcsin_vs_ref.png');
...
writematrix(err_arcsin, 'report/err_arcsin.csv');
writematrix(arcsin*180/pi, 'report/arcsin.csv');
writematrix(ref_asin*180/pi,"report/ref_asin.csv");
saveas(gcf, 'report/err_arcsin.png');